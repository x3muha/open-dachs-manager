...
<div class='signatures'><div class='signature'><span class='label'>Ausführender Betrieb</span><strong>{_h(protocol.get('technician'))}</strong><div class='signature-line'>Name / digitale Freigabe / Datum</div></div><div class='signature'><span class='label'>Betreiber</span><strong>Kenntnisnahme optional</strong><div class='signature-line'>Name / Unterschrift / Datum</div></div></div><footer class='footer'><span>Open Dachs Manager · V3 1.1.0 · unabhängiges Open-Source-Projekt</span><span>{document_id} · 1/3</span></footer></section>
...
def report_pdf(report: dict, protocol: dict, completion: dict | None = None) -> bytes:
    ...
    def page_footer(canvas, doc):
        ...
        canvas.drawString(11 * mm, 5.5 * mm, "Open Dachs Manager · V3 1.1.0 · unabhängiges Open-Source-Projekt")
